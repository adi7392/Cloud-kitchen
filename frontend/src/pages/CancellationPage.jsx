    ...
    <PolicyPage title="Cancellation Policy" lastUpdated="June 2025">
      ...
      <PolicySection title="2. How to Cancel">
        <PolicyList items={[
          ...
          "Alternatively, call us immediately at +91 73920 62928 and we will attempt to stop preparation.",
        ]} />
      </PolicySection>

      <PolicySection title="3. Cancellation by Cloud Kitchen">
      ...
      <PolicySection title="4. Refund on Cancellation">
        <PolicyList items={[
          ...
          "Cancellations initiated by Cloud Kitchen: full refund regardless of stage.",
      ...
      <PolicySection title="6. Contact">
        <p>
          ...
          or call <a href="tel:+917392062928" className="text-mm-red hover:underline">+91 73920 62928</a>.
        </p>
      </PolicySection>
    </PolicyPage>
  );
