  ...
  return (
    <PolicyPage title="Refund Policy" lastUpdated="June 2025">
      <PolicySection title="1. Overview">
        <p>
          At Cloud Kitchen, we take quality seriously. If you are not satisfied with your order, we are
      ...
      <PolicySection title="4. How to Request a Refund">
        ...
        <PolicyList items={[
          ...
          "Email support@cloudkitchen.app or call +91 73920 62928 with your order number.",
