  ...
  return (
    <PolicyPage title="Privacy Policy" lastUpdated="June 2025">
      <PolicySection title="1. Introduction">
        <p>
          Cloud Kitchen ("we", "us", "our") is committed to protecting your personal information. This
      ...
      <PolicySection title="8. Your Rights">
        ...
        <p className="mt-2">To exercise any of these rights, email us at <a href="mailto:support@ge " className="text-mm-red hover:underline">support@cloudkitchen.app</a>.</p>
      </PolicySection>
