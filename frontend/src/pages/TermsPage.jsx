  ...
  return (
    <PolicyPage title="Terms & Conditions" lastUpdated="June 2025">
      <PolicySection title="1. Agreement to Terms">
        <p>
          By accessing or using the Cloud Kitchen website (cloud-kitchen.vercel.app) or our mobile application,
      ...
      <PolicySection title="2. About Us">
        <p>
          Cloud Kitchen (referred to as "we", "us", or "our") is a food delivery and takeaway service
          operated from Gyan Mandir Chowk, Ekta Vihar, New Delhi – 110044, India.
          Contact: <a href="mailto:support@cloudkitchen.app" className="text-mm-red hover:underline">support@cloudkitchen.app</a> | +91 73920 62928.
        </p>
      </PolicySection>
      ...
      <PolicySection title="7. Intellectual Property">
        <p>
          ...
          Cloud Kitchen and may not be reproduced without prior written consent.
        </p>
      </PolicySection>

      <PolicySection title="8. Limitation of Liability">
        <p>
          To the fullest extent permitted by law, Cloud Kitchen shall not be liable for any indirect,
      ...
      <PolicySection title="10. Contact">
        <p>
          ...
          <a href="mailto:support@cloudkitchen.app" className="text-mm-red hover:underline">support@cloudkitchen.app</a>.
        </p>
      </PolicySection>
    </PolicyPage>
  );
