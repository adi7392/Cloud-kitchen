    ...
    <div className="min-h-screen bg-mm-black flex overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-3 select-none">
          ...
          <div className="leading-none">
            <span className="block font-brand text-[1.6rem] text-mm-gold leading-tight">Cloud</span>
            <span className="block font-display text-[1.2rem] tracking-[0.22em] text-mm-cream leading-tight">KITCHEN</span>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center
        ...
        <div className="flex lg:hidden items-center gap-2.5 mb-8 select-none">
          ...
          <div className="leading-none">
            <span className="block font-brand text-[1.4rem] text-mm-gold leading-tight">Cloud</span>
            <span className="block font-display text-[1rem] tracking-[0.2em] text-mm-cream">KITCHEN</span>
          </div>
        </div>
