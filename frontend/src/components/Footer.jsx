          ...
          <div className="lg:col-span-1 flex flex-col gap-5">
            <a href="#home" className="flex items-center gap-2.5 select-none w-fit">
              ...
              <div className="leading-none">
                ...
                <span className="block font-display text-[1.05rem] tracking-[0.2em] text-mm-cream leading-tight">KITCHEN</span>
              </div>
            </a>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col items-center sm:items-start gap-1">
            <p className="font-body text-xs text-mm-muted text-center sm:text-left">
              © {new Date().getFullYear()} Cloud Kitchen. All rights reserved.
