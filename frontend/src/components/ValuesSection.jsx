...
const VALUES = [
  ...
  },
  {
    ...
    body:    "Cloud Kitchen was born in this neighbourhood and we intend to grow here. We source from local vendors, hire locally, and price our food so that the office peon and the office VP can both afford to eat here.",
